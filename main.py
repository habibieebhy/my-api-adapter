...
class McpDataToolsImpl:
    ...
    def _collect_params(self, local_vars: dict) -> dict:
        ...
        params.pop('kwargs', None) # If locals() includes kwargs
        
        # For GET/Read operations, we remove None to clean up query parameters
...
async def get_users_list(
    ...
    role: Annotated[str | None, "Filter by role."] = None, 
    region: Annotated[str | None, "Filter by region."] = None,
    area: Annotated[str | None, "Filter by area."] = None, 
...
async def get_dealers_list(
    ...
    region: Annotated[str | None, "Filter by region."] = None, 
    area: Annotated[str | None, "Filter by area."] = None,
    type: Annotated[str | None, "Filter by type."] = None, 
...
async def get_dvr_reports(
    ...
    limit: Annotated[int, Field(description="Max records (default 50).", default=50)] = 50,
    userId: Annotated[int | None, "Filter by user ID."] = None, 
    dealerType: Annotated[str | None, "Filter by dealer type."] = None,
...
async def post_sales_order(
    salesmanId: Annotated[int, "The salesman's ID."], 
    dealerId: Annotated[str, "The dealer's ID."],
    quantity: Annotated[float, "Order quantity."], 
    unit: Annotated[str, "Unit of quantity (e.g., 'MT')."],
...
async def post_dvr_report(
    ...
    dealerType: Annotated[str, "Type of dealer."], 
    location: Annotated[str, "Location of the visit."],
    latitude: Annotated[float, "Geographical latitude."], 
    longitude: Annotated[float, "Geographical longitude."],
    visitType: Annotated[str, "Type of visit."], 
    dealerTotalPotential: Annotated[float, "Dealer's total potential."],
    ...
    **extra_params: Dict[str, Any]
    ...
    if 'overdueAmount' in data and data['overdueAmount'] is not None: data['overdueAmount'] = str(data['overdueAmount'])
...
async def post_tvr_report(
    ...
    conversionQuantityValue: Annotated[float | None, "Estimated conversion volume (in MT)."] = None,
